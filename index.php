 <?php
// INSERT INTO `note` (`sno`, `tittle`, `description`, `dt`) VALUES ('1', 'Go to buy Fruits', 'Hey Angad,\r\nI want to buy fruits. Delete this notes once you are done with this task.', current_timestamp());
...
if(!$conn){
    die("Could not connect to bd" . mysqli_connect_error());
}
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    if(isset($_POST['snoEdit'])){
        ...
        if ($result){
            ...
            echo "The record could not be inserted successfully";
    }
}
}
 ...
 <body>
     ...
     <nav class="navbar navbar-expand-lg bg-dark navbar-dark tertiary">
         <div class="container-fluid">
             <a class="navbar-brand" href="#"><img src="img/phplogo.png" class="img-fluid rounded-circle"
                     width="70px"></a>
